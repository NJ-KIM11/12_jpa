...
public class ProblemOfUsingDirectSQLTests {
    ...
    // test 하위에서는 메소드 또는 클래스 단위로 실행가능
    ...
    *  또한 객체를 사용할 때 SQL 에 의존하면 객체에 값이 무엇이 들어있는지 확인하기 위해 SQL 을 매번 살펴야 한다.
    * */
    ...
    * */
    ...
    void testAssociatedObject() throws SQLException {
        String query = "SELECT A.MENU_CODE, A.MENU_NAME, A.MENU_PRICE, B.CATEGORY_CODE, B.CATEGORY_NAME, A.ORDERABLE_STATUS FROM TBL_MENU A " +
    ...
    void testEquals() throws SQLException {
        ...
        // 내용물은 같아도 주소값이 다른 다른 객체이다.
        // 오버라이드 등을 통해서만 내용 비교가 가능하다.( JPA는 자동 비교 가능)
