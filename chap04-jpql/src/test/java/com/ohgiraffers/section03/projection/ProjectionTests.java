...
public class ProjectionTests {
    ...
    *
    *  4. new 명령어를 활용한 프로젝션
    *  - 다양한 종류의 단순 값들을 dto 로 바로 조회하는 방식으로 new 패키지명.dto명을
    * 쓰면 해당 dto로 바로 반환 받을 수 있다.
    ...
    * */
    ...
    void 단일_엔티티_프로젝션_테스트(){
        String jpql = "SELECT m FROM menu_section03 m";         // m은 엔티티 객체이다(엔티티 객체조회)
    ...
    void 양방향_연관관계_엔티티_프로젝션_테스트(){
        ...
        for (BiDirectionMenu bidirectionMenu : list) {
            System.out.println(bidirectionMenu);
        }
    }
    ...
    * */
    ...
    void test4(){
        ...
        /*List<Object[]> categoryCodeAndNameList = entityManager.createQuery(jpql).getResultList();

        Assertions.assertNotNull(categoryCodeAndNameList);
        for (Object[] categoryCodeAndName : categoryCodeAndNameList) {
            for (Object categoryName : categoryCodeAndName) {
                System.out.println(categoryName);
            }
        }*/
