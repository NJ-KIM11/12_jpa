...
public class A_EntityManagerLifeCycleTests {
    ...
    *  엔티티 매니저는 엔티티를 저장하는 메모리상의 데이터베이스를 관리하는 인스턴스 이다.
    ...
    * */
    ...
    @Test
    public void 엔티티_메니저_팩토리와_엔티티_메니저_생명주기_확인1(){
        System.out.println("entityManagerFactory1.hashCode = " + entityManagerFactory.hashCode());
        System.out.println("entityManager1.hashCode = " + entityManager.hashCode());
    }
    @Test
    public void 엔티티_메니저_팩토리와_엔티티_메니저_생명주기_확인2(){
